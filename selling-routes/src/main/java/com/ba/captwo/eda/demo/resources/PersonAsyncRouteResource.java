...
public class PersonAsyncRouteResource implements PersonResource {
    ...
    public Response createPerson(String fname, String lname, String address, String city) {
        ...
        try {
            ...
            Future<Object> future = t.asyncRequestBody("direct-vm:selling.services.person.create", RouteUtils.toJson(p));
    ...
    public Response deletePerson(int pid) {
        ...
        try {
            ...
            ProducerTemplate t = camelContext.createProducerTemplate();
            Future<Object> future = t.asyncRequestBodyAndHeaders("direct-vm:selling.services.person.delete", null, personDetails);
